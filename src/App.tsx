...
const App: React.FC = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      description: 'Современное оборудование для шиномонтажа и высокоточной балансировки',
      price: '1000 ₽',
      icon: <Settings className="w-8 h-8" />
    },
    {
      title: 'Установка би-ЛЭД линз в фары',
      description: 'Качественная установка би-ЛЭД линз для улучшения света фар',
      price: '3000 ₽',
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex space-x-8">
              ...
              <a href="#equipment" onClick={(e) => smoothScroll(e, '#equipment')} className="hover:text-red-500 transition">Оборудование</a>
          ...
          {isMenuOpen && (
            <nav className="md:hidden mt-4 pb-4 space-y-3">
              ...
              <a href="#equipment" onClick={(e) => smoothScroll(e, '#equipment')} className="block hover:text-red-500 transition">Оборудование</a>
      ...
      <section className="bg-gradient-to-r from-gray-900 via-black to-gray-900 text-white py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 text-gray-300">
            Современное оборудование и качественный ремонт вашего автомобиля
          </p>
      ...
      <section id="services" className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="mt-12 bg-gradient-to-r from-red-600 to-red-700 rounded-xl p-8 text-white text-center">
            <h3 className="text-2xl font-bold mb-4">Профессиональный шиномонтаж</h3>
            <p className="text-lg mb-6">Современное оборудование для шиномонтажа, высокоточной балансировки и ремонта шин</p>
      ...
      <section id="equipment" className="py-16 bg-gray-100">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center mb-12">Технологии и оснащение</h2>
          
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="bg-white rounded-xl p-8 shadow-lg mb-8">
                <h3 className="text-2xl font-bold mb-6 text-red-600">Современное оборудование</h3>
                <ul className="space-y-4 text-lg">
                  <li className="flex items-start space-x-3">
                    <div className="w-2 h-2 bg-red-600 rounded-full mt-2 flex-shrink-0"></div>
                    <span>Современное шиномонтажное оборудование</span>
                  </li>
                  <li className="flex items-start space-x-3">
                    <div className="w-2 h-2 bg-red-600 rounded-full mt-2 flex-shrink-0"></div>
                    <span>Станки высокоточной балансировки колёс</span>
                  </li>
                  <li className="flex items-start space-x-3">
                    <div className="w-2 h-2 bg-red-600 rounded-full mt-2 flex-shrink-0"></div>
                    <span>Полуавтоматическое сварочное оборудование</span>
                  </li>
                  <li className="flex items-start space-x-3">
                    <div className="w-2 h-2 bg-red-600 rounded-full mt-2 flex-shrink-0"></div>
                    <span>Профессиональное оборудование для установки би-ЛЭД линз</span>
                  </li>
                </ul>
              </div>
              
              {/* <div className="bg-red-600 text-white rounded-xl p-6"> */}
              {/*   <h4 className="text-xl font-bold mb-4">Установка би-ЛЭД линз</h4> */}
              {/*   <p className="mb-4">Профессиональная установка би-ЛЭД линз в фары для улучшения световых характеристик и внешнего вида автомобиля.</p> */}
              {/*   <div className="text-2xl font-bold">от 3000 ₽</div> */}
              {/* </div> */}
            </div>
            ...
            <div className="bg-white rounded-xl overflow-hidden shadow-lg">
              <img 
                src={workshopPhoto} 
                alt="Автосервис VM Service"
                className="w-full h-96 object-cover"
              />
              <div className="p-6">
                <h3 className="text-xl font-bold mb-2">Рабочая зона</h3>
                <p className="text-gray-600">Профессиональное пространство для качественного ремонта</p>
              </div>
            </div>
          </div>
        </div>
